...
exports.declineSubscription = void 0;
const soapwrapper_1 = require("./../helper/soapwrapper");
function declineSubscription(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        res.json(yield (0, soapwrapper_1.callSoapMethod)(client, "declineSubscriptionRequest", args));
    });
}
